...
import 'package:weekly_bible_trivia/screens/profile_screen.dart';
...
class ApplicationRouter {
  Route call(RouteSettings settings) {
      switch (settings.name) {
        ...
        case RoutePaths.fromHomeToProfileScreen:
          return AnimationPage(startPage: const HomeScreen(), endPage: const ProfileScreen(), animationDirection: AnimationDirection.upward);
        ...
        case RoutePaths.fromProfileToHomeScreen:
          return AnimationPage(startPage: const ProfileScreen(), endPage: const HomeScreen(), animationDirection: AnimationDirection.downward);
